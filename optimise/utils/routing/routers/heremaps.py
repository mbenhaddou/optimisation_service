...
class HereMaps:
    ...
    def matrix(  # noqa: C901
        ...
        out_array: Optional[List[str]] = ["traveltime", "distance"],
        truck_type: Optional[str] = None,
        trailers_count: Optional[int] = None,
        shipped_hazardous_goods: Optional[List[str]] = None,
        limited_weight: Optional[int] = None,
        ...
        **matrix_kwargs
        ...
        :param out_array: Defines which attributes are included in
        ...
        if out_array is not None:
            params["summaryAttributes"] = convert.delimit_list(out_array, ",")
